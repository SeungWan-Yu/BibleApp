...
//        Log.e("idididididididi", String.valueOf(TextArray[0]));
        ...
        pref = getSharedPreferences("may", MODE_PRIVATE);
        ...
        if(b1.equals("1")){
            button1.setBackgroundResource(R.drawable.button_may2);
        }
        if(b2.equals("1")){
            button2.setBackgroundResource(R.drawable.button_may2);
        }
        if(b3.equals("1")){
            button3.setBackgroundResource(R.drawable.button_may2);
        }
        if(b4.equals("1")){
            button4.setBackgroundResource(R.drawable.button_may2);
        }
        if(b5.equals("1")){
            button5.setBackgroundResource(R.drawable.button_may2);
        }
        if(b6.equals("1")){
            button6.setBackgroundResource(R.drawable.button_may2);
        }
        if(b7.equals("1")){
            button7.setBackgroundResource(R.drawable.button_may2);
        }
        if(b8.equals("1")){
            button8.setBackgroundResource(R.drawable.button_may2);
        }
        if(b9.equals("1")){
            button9.setBackgroundResource(R.drawable.button_may2);
        }
        if(b10.equals("1")){
            button10.setBackgroundResource(R.drawable.button_may2);
        }
        if(b11.equals("1")){
            button11.setBackgroundResource(R.drawable.button_may2);
        }
        if(b12.equals("1")){
            button12.setBackgroundResource(R.drawable.button_may2);
        }
        if(b13.equals("1")){
            button13.setBackgroundResource(R.drawable.button_may2);
        }
        if(b14.equals("1")){
            button14.setBackgroundResource(R.drawable.button_may2);
        }
        if(b15.equals("1")){
            button15.setBackgroundResource(R.drawable.button_may2);
        }
        if(b16.equals("1")){
            button16.setBackgroundResource(R.drawable.button_may2);
        }
        if(b17.equals("1")){
            button17.setBackgroundResource(R.drawable.button_may2);
        }
        if(b18.equals("1")){
            button18.setBackgroundResource(R.drawable.button_may2);
        }
        if(b19.equals("1")){
            button19.setBackgroundResource(R.drawable.button_may2);
        }
        if(b20.equals("1")){
            button20.setBackgroundResource(R.drawable.button_may2);
        }
        if(b21.equals("1")){
            button21.setBackgroundResource(R.drawable.button_may2);
        }
        if(b22.equals("1")){
            button22.setBackgroundResource(R.drawable.button_may2);
        }
        if(b23.equals("1")){
            button23.setBackgroundResource(R.drawable.button_may2);
        }
        if(b24.equals("1")){
            button24.setBackgroundResource(R.drawable.button_may2);
        }
        if(b25.equals("1")){
            button25.setBackgroundResource(R.drawable.button_may2);
        }
        if(b26.equals("1")){
            button26.setBackgroundResource(R.drawable.button_may2);
        }
        if(b27.equals("1")){
            button27.setBackgroundResource(R.drawable.button_may2);
        }
        if(b28.equals("1")){
            button28.setBackgroundResource(R.drawable.button_may2);
        }
        if(b29.equals("1")){
            button29.setBackgroundResource(R.drawable.button_may2);
        }
        if(b30.equals("1")){
            button30.setBackgroundResource(R.drawable.button_may2);
        }
        if(b31.equals("1")){
            button31.setBackgroundResource(R.drawable.button_may2);
        }
        if(b32.equals("1")){
            button32.setBackgroundResource(R.drawable.button_may2);
        }
        if(b33.equals("1")){
            button33.setBackgroundResource(R.drawable.button_may2);
        }
        if(b34.equals("1")){
            button34.setBackgroundResource(R.drawable.button_may2);
        }
        if(b35.equals("1")){
            button35.setBackgroundResource(R.drawable.button_may2);
        }
        if(b36.equals("1")){
            button36.setBackgroundResource(R.drawable.button_may2);
        }
